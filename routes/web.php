...
Route::post('/register/proses', '\App\Http\Controllers\Auth\RegisterController@registerProses')->name('register.proses');
...
Route::group(['prefix' => 'siswa'], function () {
	...
	Route::get('daftar-ujian', 'SiswaController@daftarUjian');
	...
	Route::get('cetak/pdf/sertifikat-ujian-persiswa/{siswa}/{soal}', 'LaporanController@pdfSertifikatUjianPersiswa');
});
