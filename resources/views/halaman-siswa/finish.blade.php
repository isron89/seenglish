@extends('layouts.app')
@section('title', 'Selesai Ujian - '.Auth::user()->nama)
@section('breadcrumb')
	    ...
	    <div class="box-body">
	    	<center>
	    		...
	    		<p style="color: #848383; font-size: 14pt; margin: 0">
	    			Nilai kamu sudah keluar, untuk melihat nilai dan cetak sertifikat klik <a href="{{ url('siswa/history-ujian') }}">disini!</a>
	    			<!-- @if($soal->kkm < $nilai)
