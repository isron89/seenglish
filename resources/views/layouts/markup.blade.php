...
<head>
  ...
  <title>SE English - Halaman Utama</title>
  <meta content="Platform Tes TOEFL di Malang Raya" name="description">
  <meta content="Tes, Toefl, English, Malang" name="keywords">
...
<body>
  ...
  <script src="{{ asset('/vendor/php-email-form/validate.js') }}" type="text/javascript"></script>
