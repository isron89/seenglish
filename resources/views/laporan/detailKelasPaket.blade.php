...
<div class="col-md-12">
  <div class="box box-primary">
      ...
      <h3 class="box-title">Laporan paket soal <small>{{ $soal->paket }}</small> sesi <small>{{ $kelas->nama }}</small></h3>
    </div>
    <div class="box-body">
      ...
      <table class="table table-condensed table-hover" id="table_detail">
        <caption><i>Peserta yang mengerjakan paket soal <small>{{ $soal->paket }}</small></i></caption>
        <thead>
          <tr>
            <th>Nama</th>
            <th>Email</th>
