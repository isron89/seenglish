@extends('layouts.app')
@section('title', 'Detail Laporan '.$siswa->nama)
@section('breadcrumb')
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-2 col-sm-4">
					...
					@endif --}}
					@if($siswa->gambar != '')
						<img class="profile-user-img img-responsive img-rounded" src="{{ url('/assets/img/user/'.$siswa->gambar) }}" alt="User profile picture">
					@else
						<img class="profile-user-img img-responsive img-rounded" src="{{ url('/assets/img/noimage.jpg') }}" alt="User profile picture">
					@endif
				</div>
				<div class="col-md-10 col-sm-8">
					...
					@if($hasil_ujian->status == 1)
					<a target="_blank" href="{{ url('/cetak/pdf/hasil-ujian-persiswa/'.$siswa->id.'/'.$soal->id) }}" class="btn btn-warning btn-md" data-toggle='tooltip' title="Cetak laporan hasil ujian paket soal {{ $soal->paket }} untuk peserta an. {{ $siswa->nama }}"><i class="fa fa-file-pdf-o"></i> Cetak Laporan</a>
					@endif
				</div>
			</div>
			<hr>
...
<div class="col-md-4">
	...
	<div class="box box-danger">
		<div class="box-body">
			<p><i class="fa fa-question-circle" style="color: indianred"></i> Hasil kerja peserta dapat digunakan sebagai bahan evaluasi belajar peserta.</p>
			<p>Anda dapat mengelompokan jawaban peserta yang benar atau salah, sehingga memudahkan untuk mengidentifikasi materi apa yang sudah ataupun belum dikuasai oleh peserta.</p>
		</div>
	</div>
	@endif
</div>
