    ...
    <div class="box-body">
      ...
      <div class="well" style="margin-top: 15px; display: none;" id="wrap-soal">
        <form class="form-horizontal" id="formSoal">
          ...
          <input type="hidden" name="kkm" value="425">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="paket" placeholder="Paket Soal Sesi 1">
              </div>
            </div>
            <div class="form-group">
              <label for="paket" class="col-sm-2 control-label">Deskripsi</label>
              <div class="col-sm-8">
                <textarea name="deskripsi" class="form-control" placeholder="Isi Deskripsi"></textarea>
              </div>
            </div>
            {{-- <div class="form-group">
