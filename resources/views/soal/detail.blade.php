...
<div class="col-md-4">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">Data Sesi</h3>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
      </div>
    </div>
    <div class="box-body">
            ...
            <td align="center">
              <div id="wrap-status-soal{{ $data_kelas->id }}">
                @if($data_kelas->id_soal != "")
                  ...
                  <span data-toggle="tooltip" title="Sesi ini dapat mengerjakan soal Anda. Klik untuk merubah status soal pada sesi ini." id="terbit-soal{{ $data_kelas->id }}"><i style="color: limegreen; font-size: 16pt; cursor: pointer;" class="fa fa-check-square-o"></i></span>
                  @else
                  <span data-toggle="tooltip" title="Sesi ini tidak dapat mengerjakan soal Anda. Klik untuk merubah status soal pada sesi ini." id="terbit-soal{{ $data_kelas->id }}"><i style="color: red; font-size: 16pt; cursor: pointer;" class="fa fa-minus-square-o"></i></span>
                  @endif
                @else
      ...
      <p style="margin-top: 20px" class="text-muted"><i class="fa fa-info-circle"></i> <b>Data sesi</b> adalah daftar sesi yang akan menerima soal ini. Anda dapat menerbitkan soal ke sesi yang akan mengerjakan soal.</p>
    </div>
  </div>
  @else
  <div class="box box-info">
    ...
    <div class="box-body">
      <p>Seluruh peserta (sesi manapun) dapat mengakses soal yang Anda terbitkan. Soal dalam format latihan bisa dikerjakan berkali-kali oleh peserta yang mengkses soal Anda.</p>
      <p>Susunlan soal untuk memantapkan pemahaman peserta akan materi terkait. Anda dapat memantau peserta yang mengakses soal latihan yang Anda buat melalui halaman <b>Laporan.</b></p>
    </div>
  </div>
  @endif
</div>
