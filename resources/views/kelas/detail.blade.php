...
@section('breadcrumb')
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ url('/master/kelas') }}">Sesi</a></li>
...
<div class="col-md-9">
  <div class="box box-primary">
      ...
      <div class="pull-right">
        ...
        <a href="{{ url('master/kelas/ubah/'.$kelas->id) }}" class="btn btn-primary" id="btn-create">Ubah Sesi</a>
        {{-- <button type="button" class="btn btn-danger" id="btn-siswa"><i class="fa fa-trash"></i> Kosongkan Sesi</button> --}}
      </div>
    </div>
    <div class="box-body">
    	<table class="table table-hover table-condensed" id="table_detail_kelas">
    		<caption><i>Daftar peserta di sesi {{ $kelas->nama }}.</i></caption>
    		<thead>
    			<tr>
    				<th>Nama</th>
    				<th>Email</th>
...
$(document).ready(function (){
    ...
    columns: [
      ...
      {data: 'no_hp', name: 'no_hp', orderable: true, searchable: true },
