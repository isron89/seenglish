      ...
      <div class="box-body">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <img src="{{ $siswa->gambar ? url('assets/img/user/'.$siswa->gambar) : url('assets/img/noimage.jpg') }}" id="wrap-img" class="img img-thumbnail" style="width: 30%"><br>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="pendidikan" name="pendidikan" placeholder="Pendidikan" value="{{ $siswa->pendidikan }}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="no_hp" class="form-control" id="no_hp" name="no_hp" placeholder="No. HP" value="{{ $siswa->no_hp }}">
              </div>
            </div>
            <div class="form-group">
              <label for="alamat" class="col-sm-2 control-label">Alamat</label>
              <div class="col-sm-10">
                <textarea class="form-control" name="alamat" id="alamat" cols="20" rows="10">{{ $siswa->alamat }}</textarea>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="kelas" class="col-sm-2 control-label">Sesi</label>
              <div class="col-sm-10">
                <select class="form-control select2Class" id="kelas" name="kelas">
                	<option value="@if($siswa->getKelas) {{ $siswa->getKelas->id }} @else Pilih Sesi @endif">@if($siswa->getKelas) {{ $siswa->getKelas->nama }} @else Pilih Sesi @endif</option>
                	@if($kelas->count())
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Bukti Transfer</label>
              <div class="col-sm-10">
                <img src="{{ $siswa->bukti_transfer ? url('assets/img/user/'.$siswa->bukti_transfer) : url('assets/img/noimage.jpg') }}" id="wrap-img" class="img img-thumbnail" style="width: 30%"><br>
              </div>
            </div>
